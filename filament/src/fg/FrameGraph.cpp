...
struct RenderTarget final : public VirtualResource { // 96
    ...
    PassNode* first = nullptr;              // pass that needs to instantiate the RT
    PassNode* last = nullptr;               // pass that can destroy the RT
